...
const ProgrammingScenarioTest = ({ onComplete }) => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await api.getScenarioQuestions();
...
export default ProgrammingScenarioTest;