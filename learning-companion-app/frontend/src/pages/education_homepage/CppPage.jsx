// src/pages/education_homepage/CppPage.jsx
...
export default function CppPage() {
  ...
  const sharedTopics = {
    ...
    intermediate: [
      ...
      "File I/O & JSON Basics",
      "CMake & Build Fundamentals",
    ],
    advanced: [
      ...
      visual: {
        ...
        levels: {
          beginner: {
            ...
            route: "/education_homepage/lesson/cpp-visual-beginner",
          },
          intermediate: {
      ...
      hands_on: {
        ...
        levels: {
          beginner: {
            ...
            eta: "~6–8 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/cpp-hands-on-beginner",
          },
          intermediate: {
      ...
      theoretical: {
        ...
        levels: {
          beginner: {
            ...
            eta: "~5–7 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/cpp-theoretical-beginner",
          },
          intermediate: {
      ...
      interactive: {
        ...
        levels: {
          beginner: {
            ...
            eta: "~5–7 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/cpp-interactive-beginner",
          },
          intermediate: {
  ...
  const styleOptions = [
    { key: "visual", title: "Visual Learner", text: "Flow diagrams, memory layout visuals, UML class graphs" },
    { key: "hands_on", title: "Hands-On Learner", text: "Code-first labs & guided mini projects" },
    { key: "theoretical", title: "Theoretical Learner", text: "Language rules, compilation model, standard library concepts" },
  ...
  return (
    <div style={styles.page}>
      <header style={styles.hero}>
        <h1 style={styles.title}>Master C++</h1>
        <p style={styles.subtitle}>
          Learn modern C++ with clear theory, STL-powered practice, and real-world examples — tailored
