// src/pages/education/JavaPage.jsx
...
export default function JavaPage() {
  ...
  // Keep topics similar across styles; tuned for Java
  const sharedTopics = {
    beginner: [
      "JDK/JRE & Project Setup",
    ...
    intermediate: [
      ...
      "Packages, Build Tools (Maven/Gradle)",
      "Exceptions & Unit Testing (JUnit)",
      "I/O & Files (NIO)",
      "HTTP/JSON (HttpClient)",
    ],
    advanced: [
      "Generics & Streams",
  ...
  const catalog = useMemo(
    () => ({
      visual: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Visual (Java)",
            eta: "~5–7 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/java-visual-beginner",
          },
          intermediate: {
            title: "Intermediate · Visual (Java)",
            eta: "~9–12 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Visual (Java)",
            eta: "~12–16 hours",
      ...
      hands_on: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Hands-On (Java)",
            eta: "~6–8 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/java-hands-on-beginner",
          },
          intermediate: {
            title: "Intermediate · Hands-On (Java)",
            eta: "~10–14 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Hands-On (Java)",
            eta: "~14–18 hours",
            topics: sharedTopics.advanced,
          },
        },
      ...
      theoretical: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Theory (Java)",
            eta: "~5–7 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/java-theoretical-beginner",
          },
          intermediate: {
            title: "Intermediate · Theory (Java)",
            eta: "~9–12 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Theory (Java)",
            eta: "~12–16 hours",
            topics: sharedTopics.advanced,
          },
        },
      ...
      interactive: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Interactive (Java)",
            eta: "~5–7 hours",
            topics: sharedTopics.beginner,
            route: "/education_homepage/lesson/java-interactive-beginner",
          },
          intermediate: {
            title: "Intermediate · Interactive (Java)",
            eta: "~9–12 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Interactive (Java)",
            eta: "~12–14 hours",
            topics: sharedTopics.advanced,
          },
        },
  ...
  const styleOptions = [
    { key: "visual", title: "Visual Learner", text: "Learn through diagrams and class hierarchy charts" },
    { key: "hands_on", title: "Hands-On Learner", text: "Practice with small projects and labs" },
    { key: "theoretical", title: "Theoretical Learner", text: "Deep dives into language internals" },
    { key: "interactive", title: "Interactive Learner", text: "Quizzes, coding drills, and challenges" },
  ];
  ...
  return (
    <div style={styles.page}>
      <header style={styles.hero}>
        <h1 style={styles.title}>Master Java</h1>
        <p style={styles.subtitle}>
          From syntax to JVM-level insights — Java, structured for your learning style with
          practical examples and clear mental models.
        </p>
