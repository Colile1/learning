// src/pages/education/SqlPage.jsx
...
export default function SqlPage() {
  ...
  // Keep topics similar across styles; tuned for SQL
  const sharedTopics = {
    beginner: [
      "Relational basics & schema",
  ...
  const catalog = useMemo(
    () => ({
      visual: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Visual (SQL)",
            eta: "~3–5 hours",
            topics: sharedTopics.beginner,
            route: "/lessons/sql/visual/beginner",
          },
          intermediate: {
            title: "Intermediate · Visual (SQL)",
            eta: "~6–8 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Visual (SQL)",
            eta: "~9–12 hours",
      ...
      hands_on: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Hands-On (SQL)",
            eta: "~4–6 hours",
            topics: sharedTopics.beginner,
            route: "/lessons/sql/hands_on/beginner",
          },
          intermediate: {
            title: "Intermediate · Hands-On (SQL)",
            eta: "~7–10 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Hands-On (SQL)",
            eta: "~10–14 hours",
            topics: sharedTopics.advanced,
          },
        },
      ...
      theoretical: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Theory (SQL)",
            eta: "~3–5 hours",
            topics: sharedTopics.beginner,
            route: "/lessons/sql/theoretical/beginner",
          },
          intermediate: {
            title: "Intermediate · Theory (SQL)",
            eta: "~6–8 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Theory (SQL)",
            eta: "~9–12 hours",
            topics: sharedTopics.advanced,
          },
        },
      ...
      interactive: {
        ...
        levels: {
          beginner: {
            title: "Beginner · Interactive (SQL)",
            eta: "~3–5 hours",
            topics: sharedTopics.beginner,
            route: "/lessons/sql/interactive/beginner",
          },
          intermediate: {
            title: "Intermediate · Interactive (SQL)",
            eta: "~6–8 hours",
            topics: sharedTopics.intermediate,
          },
          advanced: {
            title: "Advanced · Interactive (SQL)",
            eta: "~9–12 hours",
            topics: sharedTopics.advanced,
          },
        },
  ...
  const styleOptions = [
    { key: "visual", title: "Visual Learner", text: "ERDs, query flow diagrams, and visual plans" },
    { key: "hands_on", title: "Hands-On Learner", text: "Practice with datasets and lab queries" },
    { key: "theoretical", title: "Theoretical Learner", text: "Relational theory & set logic" },
    { key: "interactive", title: "Interactive Learner", text: "Quizzes, code drills, and challenge sets" },
  ];
  ...
  return (
    <div style={styles.page}>
      <header style={styles.hero}>
        <h1 style={styles.title}>Master SQL</h1>
        <p style={styles.subtitle}>
          Query design, performance, and data modeling — SQL tailored to your learning style with
          practical datasets and clear mental models.
        </p>
